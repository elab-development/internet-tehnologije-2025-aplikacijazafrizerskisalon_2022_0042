function ServiceCard({ iconSrc, title, description }) {
  return (
    <div className="flex flex-col items-center text-center group cursor-pointer">
      ...
      <h3 className="text-[#4B3928] font-semibold uppercase text-sm md:text-lg">{title}</h3>
      <p className="text-[#705B46] font-montserrat text-[10px] md:text-xs">{description}</p>
    </div>
  );
}
